...
class MeuRestaurante extends StatefulWidget {
  final String url;
  final String nome;
  ...
  @override
  State<MeuRestaurante> createState() => _MeuRestauranteState();
}

class _MeuRestauranteState extends State<MeuRestaurante> {
