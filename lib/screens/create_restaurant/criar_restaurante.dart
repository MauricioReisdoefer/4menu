    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            RestauranteForm(
              onNomeChanged: (nome) => nomeRestaurante = nome,
              onCorPrimariaChanged: (cor) => corPrimaria = cor,
              onCorSecundariaChanged: (cor) => corSecundaria = cor,
            ),
            ...
            Center(
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(backgroundColor: Colors.orange, padding: const EdgeInsets.symmetric(horizontal: 50, vertical: 15), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12))),
